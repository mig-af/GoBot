...
installAndroid(){
    ...
    sleep 2
    git clone https://github.com/mig-af/GoBot
...
configLinux(){
    ...
    clear
    sleep 3
    echo -e "\n${verde}Configuracion exitosa....dirijase a la carpeta GoBot/src y escriba 'go run bot.go' para iniciar el programa ${fin}" 
    rm $var/install.sh
    rm install.sh
